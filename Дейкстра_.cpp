...
int main()
{
    ...
    auto graph = read_graph("C:\\Users\\Даниил\\Desktop\\input.txt.txt");
    std::cout << "Отправная вершина = "; std::cin >> start_index;
    std::cout << "Конечная вершина  = "; std::cin >> end_index;
    auto path = find_path_Dijkstra(graph, start_index, end_index);
